...
struct TABLE_SHARE
{
  ...
  /*
    EITS statistics data from the last time the table was opened. This
    is typically same as any replated TABLE::stats_cb unless ANALYZE
    table has been recently run.  The pointer will be automatically
    updated next time statistics is needed.
  */
